...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      className={cn(
        "relative flex w-full flex-1 flex-col items-center bg-background md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=sidebar]:shadow-xs",
        className
      )}
...
function SidebarMenuButton({
  ...
  return (
    <Tooltip>
      {comp}
      <TooltipContent align="center" hidden={state !== "collapsed"} side="right" {...tooltip} />
    </Tooltip>
  );
}
